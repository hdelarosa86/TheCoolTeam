...
class SceneSix extends Phaser.Scene {
  ...
  create() {
    ...
    this.npcOne = createNPC(
      ...
      'ryan',
      'ryan-front',
      `Hey Fullstacker, please tell me you watched inuyasha?`,
      'npcOne',
      'BattleSceneRyan',
      2000
    );
    this.npcTwo = createNPC(
      ...
      'mark',
      'mark-right',
      `Hey Fullstacker, are you ready to get REACTO'd?`,
      'npcTwo',
      'BattleSceneMark',
      2400
    );
    this.npcThree = createNPC(
      ...
      'russell',
      'russell-right',
      'You better be ready for some interview experience?',
      'npcThree',
      'BattleSceneRussell',
      3000
    );
    this.npcFour = createNPC(
      ...
      'elliot',
      'elliot-back',
      `Hey Buddy, Are you ready for the big boss.I'll try to go easy on you?`,
      'npcFour',
      'BattleSceneEliot',
      5000
    );
