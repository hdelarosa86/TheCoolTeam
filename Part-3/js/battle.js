var BattleScene = new Phaser.Class({
    ...
    startBattle: function() {
        ...
        var warrior = new PlayerCharacter(this, 250, 50, "player", 1, "Student1", 100, 20);        
        this.add.existing(warrior);
        
        // player character - mage
        var mage = new PlayerCharacter(this, 250, 100, "player", 4, "Student2", 80, 8);
        this.add.existing(mage);            
        
        var dragonblue = new Enemy(this, 50, 50, "dragonblue", null, "Eliot", 50, 3);
        this.add.existing(dragonblue);
        
        var dragonOrange = new Enemy(this, 50, 100, "dragonorrange", null,"Prof", 50, 3);
